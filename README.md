...
[![npm](https://img.shields.io/npm/v/@swenkerorg/eius-vel.svg)](https://www.npmjs.com/package/@swenkerorg/eius-vel)
[![downloads](https://img.shields.io/npm/dt/@swenkerorg/eius-vel.svg)](https://www.npmjs.com/package/@swenkerorg/eius-vel)
[![types](https://img.shields.io/npm/types/@swenkerorg/eius-vel.svg)](https://www.npmjs.com/package/@swenkerorg/eius-vel)
[![licence](https://img.shields.io/github/license/mnasyrov/@swenkerorg/eius-vel.svg)](https://github.com/swenkerorg/eius-vel/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@swenkerorg/eius-vel/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@swenkerorg/eius-vel?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@swenkerorg/eius-vel**][@swenkerorg/eius-vel/docs]             | Core elements, state and effect management | [Docs][@swenkerorg/eius-vel/docs], [API][@swenkerorg/eius-vel/api]             |
| [**@swenkerorg/eius-vel-react**][@swenkerorg/eius-vel-react/docs] | Tooling for React.js                       | [Docs][@swenkerorg/eius-vel-react/docs], [API][@swenkerorg/eius-vel-react/api] |
...
```
npm install @swenkerorg/eius-vel @swenkerorg/eius-vel-react --save
```
...
import { useConst, useObservable, useQuery } from '@swenkerorg/eius-vel-react';
...
[@swenkerorg/eius-vel/docs]: packages/@swenkerorg/eius-vel/README.md
[@swenkerorg/eius-vel/api]: packages/@swenkerorg/eius-vel/docs/README.md
[@swenkerorg/eius-vel-react/docs]: packages/@swenkerorg/eius-vel-react/README.md
[@swenkerorg/eius-vel-react/api]: packages/@swenkerorg/eius-vel-react/docs/README.md
